...
loginFormElement.addEventListener('submit', function(event) {
  ...
  /**
   * Membuat variabel password untuk menyimpan nilai password yang didapatkan aat button ditekan.
   * @constant {string}
   */
  const password = inputPasswordElement.value;


  /* Coment : Memastikan bahwa nilai email dan password sesuai dengan nila yang tersimpan. */
